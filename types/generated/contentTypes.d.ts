...
export interface ApiFooterFooter extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    frRights: Schema.Attribute.String;
...
export interface ApiHeaderHeader extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    desktopLogo: Schema.Attribute.Media<
      'images' | 'files' | 'videos' | 'audios'
    >;
    headerLinks: Schema.Attribute.Component<'header.header-titles', true>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::header.header'
...
export interface ApiHomeHome extends Struct.SingleTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::home.home'> &
      Schema.Attribute.Private;
    programs: Schema.Attribute.Component<'home.home-programs', false>;
    publishedAt: Schema.Attribute.DateTime;
    services: Schema.Attribute.Component<'home.home-services', false>;
    testimonials: Schema.Attribute.Component<'home.home-testimonials', false>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
